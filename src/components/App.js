...
class App extends Component {
  ...
  componentDidMount() {
    ...
    this.decorationOriginalPosition =
      this.decoration.getBoundingClientRect().left;

    this.scrollEndBreakpoint =
      this.pages[this.pages.length - 1].getBoundingClientRect().left * -1;
    ...
    const galleryScrollers = document.querySelectorAll(
  ...
  setNavLink = (pageIdx) => {
    const navLinks = Array.from(
      this.navMenu.querySelectorAll(".page-titles > li")
    );
